...
const ROUND_PRODUCTS = [
    ...
    { id: 'pe-round-u-2t', name: '매설용 2U 물탱크(지하매립형)', capacity: '2', price: PRICING_DB.tanks.u_series['2'] },
    { id: 'pe-round-u-5t', name: '매설용 5U 물탱크(지하매립형)', capacity: '5', price: PRICING_DB.tanks.u_series['5'] },
];
