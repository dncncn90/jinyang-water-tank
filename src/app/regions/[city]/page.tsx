...
const regionData: Record<string, { name: string; title: string; description: string; keywords: string[] }> = {
  ...
  osan: {
    name: '오산',
    title: '오산 물탱크 저수조 도매 | PE 물탱크, 정화조 당일 배송 - 진양건재',
    description: '오산 전 지역 물탱크 및 저수조 직배송. 복잡한 전화 없이 1분 만에 확인하는 오산 지역 전용 스마트 견적 시스템.',
    keywords: ['오산 물탱크', '오산 저수조', '오산 PE물탱크', '오산 정화조', '오산 물탱크 도매', '오산 물탱크 구매', '오산 물탱크 파는곳'],
  },
};
