...
export const metadata: Metadata = {
  ...
  title: {
    template: '%s | 수원·수도권 물탱크 도매 전문 및 친환경 야자매트 공식 판매처 - 진양건재',
    default: '수원·수도권 물탱크 도매 전문 및 친환경 야자매트 공식 판매처 | 수도권 당일 직배송 - 진양건재',
  },
  description: '수원 37년 전통의 진양건재. 원형/사각 PE 물탱크, 농업용/농약용 백색 경운기 탱크, 지하 매립형(매설용) 저수조 및 고강도 친환경 야자매트(코코넛매트) 수도권 전 지역 당일 직배송 및 최저가 견적 보장.',
  keywords: [
  ...
  openGraph: {
    ...
    siteName: '진양건재 물탱크 & 야자매트',
    title: '수원·수도권 물탱크 도매 및 야자매트 최저가 | PE 물탱크, 정화조 당일 배송 - 진양건재',
    description: '수원, 용인, 화성 등 수도권 전 지역 물탱크 및 야자매트 직배송. 1분 만에 확인하는 스마트 견적 시스템! 농업용 백색 물탱크, 고강도 매립형 물탱크 및 친환경 야자매트를 정직한 가격으로 만나보세요.',
    images: [
      {
        url: '/images/hero-tanks.jpg',
        width: 1200,
        height: 630,
        alt: '진양건재 PE 물탱크 & 야자매트 전문점 - 수원·화성·용인 도매',
      },
    ],
  },
  twitter: {
