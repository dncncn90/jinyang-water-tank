...
export const metadata: Metadata = {
  ...
  title: {
    template: '%s | 수원·수도권 물탱크 도매 | PE 물탱크, 정화조 당일 배송 - 진양건재',
    default: '수원·수도권 물탱크 도매 | PE 물탱크, 정화조 당일 배송 - 진양건재',
  },
  description: '수원, 용인, 화성 등 수도권 전 지역 물탱크 직배송. 1분 만에 확인하는 스마트 견적 시스템! 1989년 설립된 37년 전통의 진양건재에서 정직한 가격으로 만나보세요.',
  keywords: [
    '수원 물탱크', '화성 물탱크 판매', '용인 PE물탱크', '안산 정화조', '수도권 물탱크 도매',
    'PE 물탱크 규격', '식수용 물탱크 가격', '5톤 물탱크 단가', '사각 물탱크 구매', '정화조 설치 단가',
    '물탱크 싼 곳', '물탱크 직배송', '물탱크 견적 문의', '재고 보유 건재상', '물탱크 도매가'
  ],
